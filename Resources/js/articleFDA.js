...
var webview = Ti.UI.createWebView({
	...
	html : '<html><head><style type="text/css">* { max-width: 270px; } body { padding: 10px; font-family: helvetica neue, helvetica, arial; width: 270px; overflow: hidden; color : #3f3f3f; } h1,h2,h3,h4,h5 { color: black; } img { max-width: 270px; } pre { white-space: pre-wrap; }</style><body><h3>' + win.theTitle + '</h3>' + win.desc  + '</body></html>'
});
