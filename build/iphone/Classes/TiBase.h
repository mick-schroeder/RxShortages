...
// in simulator we redefine to format for RxShortages Developer console
...
{\
	NSString * exceptionName = [@"org.rxshortages." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rxshortages";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIRxShortagesNativeItemNone = -1, 
	UIRxShortagesNativeItemSpinner = -2,
	UIRxShortagesNativeItemProgressBar = -3,
	
	UIRxShortagesNativeItemSlider = -4,
	UIRxShortagesNativeItemSwitch = -5,
	UIRxShortagesNativeItemMultiButton = -6,
	UIRxShortagesNativeItemSegmented = -7,
	
	UIRxShortagesNativeItemTextView = -8,
	UIRxShortagesNativeItemTextField = -9,
	UIRxShortagesNativeItemSearchBar = -10,
	
	UIRxShortagesNativeItemPicker = -11,
	UIRxShortagesNativeItemDatePicker = -12,
	
	UIRxShortagesNativeItemInfoLight = -13,
	UIRxShortagesNativeItemInfoDark = -14,
	
	UIRxShortagesNativeItemDisclosure = -15,
	
	UIRxShortagesNativeItemContactAdd = -16
};
